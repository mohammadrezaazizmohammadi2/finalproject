...
public class AllAdsController {
    ...
    private void loadAds(Integer categoryId,
        ...
        try {
            ...
            List<Ad> ads = apiClient.getAllAdsAdmin(
                    categoryId,
                    city,
                    minPrice,
                    maxPrice,
    ...
    private Parent createAdCard(Ad ad) {
        ...
        try {
            ...
            controller.setAd(
                    ...
                    true,    // showStatus
                    true,    // showDelete (ادمین می‌تونه هر آگهی‌ای رو حذف کنه)
                    false,   // showMarkSold - ادمین مالک نیست پس نباید بتونه
                    () -> handleDeleteAd(ad),
                    null
            );
